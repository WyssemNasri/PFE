...
if($post["privilege"]=="medecin")  
 {
  ...
  do{
    $x=generateKey();
    $sql = "SELECT * FROM `users` WHERE `cle` = '$x'";
    ...
    $sql1 = "INSERT INTO users (cle,nomPrenom,email,address,password,privilege,numero)
    VALUES ('$x','$nomprenom', '$email', '$adresse','$passwordi', '$privilege', '$numero');";
    $result1 = mysqli_query($connexion, $sql1);
    $sql = "INSERT INTO doctors (cle,nomPrenom, specialite)
    VALUES ('$x','$nomprenom', '$specialite');";
    $result = mysqli_query($connexion, $sql);
    $sql2 = "INSERT INTO diagnostics (Patient_key,nomPrenom)
    VALUES ('$x','$nomprenom');";
...
try {
    ...
    <body>
        <div class="container">
            <h2>🚀 Bienvenue sur ProMedPlus 📱</h2>
            <div class="message">
                <p>Merci pour votre inscription à notre application mobile ProMed+. Voici vos informations :</p>
